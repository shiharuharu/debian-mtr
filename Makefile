...
CONFIG_CLEAN_FILES = version.h.tmp
CONFIG_CLEAN_VPATH_FILES =
am__installdirs = "$(DESTDIR)$(sbindir)" "$(DESTDIR)$(man8dir)"
PROGRAMS = $(sbin_PROGRAMS)
am__mtr_SOURCES_DIST = mtr.c net.c net.h dns.c dns.h raw.c raw.h \
	split.c split.h display.c display.h report.c report.h getopt.c \
	getopt1.c getopt.h select.c select.h mtr-curses.h mtr-gtk.h \
	asn.c asn.h
am__objects_1 = asn.$(OBJEXT)
am_mtr_OBJECTS = mtr.$(OBJEXT) net.$(OBJEXT) dns.$(OBJEXT) \
	...
	select.$(OBJEXT) $(am__objects_1)
nodist_mtr_OBJECTS =
mtr_OBJECTS = $(am_mtr_OBJECTS) $(nodist_mtr_OBJECTS)
am__DEPENDENCIES_1 =
mtr_LINK = $(CCLD) $(AM_CFLAGS) $(CFLAGS) $(mtr_LDFLAGS) $(LDFLAGS) -o \
	$@
...
SOURCES = $(mtr_SOURCES) $(EXTRA_mtr_SOURCES) $(nodist_mtr_SOURCES)
DIST_SOURCES = $(am__mtr_SOURCES_DIST) $(EXTRA_mtr_SOURCES)
...
STRIP = 
VERSION = 0.85
abs_builddir = /home/wolff/mtr
abs_srcdir = /home/wolff/mtr
abs_top_builddir = /home/wolff/mtr
abs_top_srcdir = /home/wolff/mtr
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
am__quote = 
...
SUBDIRS = img
man_MANS = mtr.8
mtr_SOURCES = mtr.c net.c net.h dns.c dns.h raw.c raw.h split.c \
	split.h display.c display.h report.c report.h getopt.c \
	getopt1.c getopt.h select.c select.h mtr-curses.h mtr-gtk.h \
	$(am__append_1)
...
mtr$(EXEEXT): $(mtr_OBJECTS) $(mtr_DEPENDENCIES) 
	@rm -f mtr$(EXEEXT)
	$(mtr_LINK) $(mtr_OBJECTS) $(mtr_LDADD) $(LIBS)
